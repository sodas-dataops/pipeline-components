...
from core import algorithm_csv_missing_data_interpolation as algorithm
...
if __name__ == '__main__' :
    print('CSV Missing Data Interpolation')
    print('args:', args)
    ...
    # 원본 데이터 삭제 (delete_input 파라미터가 True인 경우)
    if args.get('delete_input', False):
        print("\n[삭제] 원본 데이터를 삭제합니다...")
        delete_file(
            s3_resource=s3_client_input1,
            bucket_name=input1['bucket_name'],
