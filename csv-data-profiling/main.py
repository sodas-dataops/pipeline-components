...
from core import algorithm_csv_data_profiling as algorithm
...
if __name__ == '__main__' :
    print('CSV Data Profiling')
    print('args:', args)
    
    # 임시 파일 경로 설정
    local_file_path = './tmp/data_profile.json'
    ...
    if args['delete_input']:
        print("\n[삭제] 원본 데이터를 삭제합니다...")
        delete_object(s3_client_input1, input1['bucket_name'], input1['object_path'])
        print("- 원본 데이터가 성공적으로 삭제되었습니다.")
    else:
        print("\n[정보] 원본 데이터는 유지됩니다.")