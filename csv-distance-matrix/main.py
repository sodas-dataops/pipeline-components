...
from core import algorithm_csv_distance_matrix as algorithm
...
if __name__ == '__main__' :
    ...
    feature_columns = settings.get('feature_columns', ['lat', 'lon'])
    distance_method = settings.get('distance_method', 'euclidean')
    
    print(f"- 설정된 특성 컬럼: {feature_columns}")
    print(f"- 설정된 거리 계산 방법: {distance_method}")
